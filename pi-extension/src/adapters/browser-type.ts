...
export const browserTypeTool = defineTool({
	...
	label: "Browser Type",
	description:
		"Type text into an input element in the browser tab. Optionally target a specific tab via tabId; when omitted, defaults to the active tab. Can optionally clear existing value and submit the form.",
