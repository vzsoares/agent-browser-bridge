...
export const ClickSchema = z.object({
	tabId: z
		...
		.int()
		.optional()
		.describe("Target tab ID. When omitted, defaults to the active tab."),
	selector: z
		.string()
...
export const ScreenshotSchema = z.object({
	tabId: z
		...
		.int()
		.optional()
		.describe("Target tab ID. Defaults to the active tab when omitted."),
	format: z
		.enum(["png", "jpeg"])
		.default("png")
...
export type ValidatedWaitForElementParams = z.infer<
	typeof WaitForElementSchema
>;
...
export const CreateTabSchema = z.object({
	url: z
		.string()
		.optional()
		.describe("URL to open in the new tab. When omitted, opens a blank tab."),
	active: z
		.boolean()
		.default(true)
		.describe(
